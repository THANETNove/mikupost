...
<div class="untree_co-section" id="home-section">
        ...
        <div class="row  mt-5">
            <div class="col-lg-9 ">
                <div class="container-manga-body">
                    ...
                    <p class="caption2"><i class="fa fa-eercast" aria-hidden="true"></i> General Category</p>
                </div>
    ...
    <div class="untree_co-section" id="about-section" id="home-section">
        <div class="containerNav-body">
            <div class="row justify-content-between  mt-5">
                ...
                <div class="col-lg-4 order-lg-2 js-custom-dots body-color-right">
